<script setup>
  ...
  //example components
  import NavbarDefault from "../../examples/navbars/NavbarDefaultEN.vue";
  import DefaultFooter from "../../examples/footers/FooterDefaultEN.vue";
  import Header from "../../examples/Header.vue";
  // sections
  import PresentationCounter from "./Sections/PresentationCounterEN.vue";
  import InformacionRelevante from './Sections/informacionRelevanteyRegistrosEN.vue'
        ...
        <div class="row">
          <div class="col-lg-12 text-center mx-auto position-relative">
            ...
            <h2 v-if="hancho<=80" class="lead text-white px-5 mt-2" :style="{ fontWeight: '300' }">
              100% made from Colombian, we are experts in chili peppers.
            </h2>
